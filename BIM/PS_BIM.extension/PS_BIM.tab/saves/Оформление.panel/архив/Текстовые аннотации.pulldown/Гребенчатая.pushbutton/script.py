...
try:
    mark = mark = CustomSelections.pick_element_by_class(AnnotationSymbol)
    if mark:
    ...
    if mark:
        ...
        while True:
            try:
                ...
                forms.alert('Некорректно установлена точка локтя. Установите точку локтя вдоль линии полки!')
                break
