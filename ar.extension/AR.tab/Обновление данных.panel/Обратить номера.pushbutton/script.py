...
__title__   = "Обратить\nномера"
__doc__ = """
Описание: Обновляет порядок нумерации помещений на этаже на обратный порядок

Как использовать: Запускаем когда секция было повернута, что привело к изменению порядка нумерации квартир на обратный.
"""
